                ...
                <div class="flex flex-col sm:flex-row items-center gap-5">
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        @if ($project->has_finished)
                            <div class="font-bold text-xs leading-[18px] text-white bg-[#F3445C] p-[2px_10px] rounded-full w-fit  top-[10px] left-[10px]">CLOSED</div>
                        @else
                            @if (!$project->has_started)
                                <div class="font-bold text-xs leading-[18px] text-white bg-[#2E82FE] p-[2px_10px] rounded-full w-fit  top-[10px] left-[10px]">HIRING</div>
                                
                            @else
                                <div class="font-bold text-xs leading-[18px] text-white bg-[#2E82FE] p-[2px_10px] rounded-full w-fit  top-[10px] left-[10px]">In Progress</div>
                            @endif
                        @endif
            ...
            <div class="bg-white flex flex-col gap-5 p-5 rounded-[20px] h-fit">
                ...
                <form action="{{route('front.apply_job.store', $project)}}" method="POST" class="flex flex-col gap-5">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 items-center">
                        ...
                        <button class="font-semibold bg-[#6635F1] p-[14px_20px] rounded-full text-center w-full text-white" type="submit">Apply Now</button>
                    </div>
                </form>
            </div>
        </div>
