    ...
    Route::prefix('admin')->name('admin.')->group(function (){
        ...
        Route::middleware('can:manage wallets')->group(function(){
            Route::get('/wallet/topups', [WalletTransactionController::class, 'wallet_topups'])
                ->name('topups');
            Route::get('/wallet/withdraws', [WalletTransactionController::class, 'wallet_withdraws'])
                ->name('withdraws');
        ...
        Route::middleware('can:manage projects')->group(function(){
            ...
            Route::get('projects/{project}/tools', [ProjectController::class, 'tools'])
                ->name('projects.tools');
            Route::post('projects/{prject}/tools/store', [ProjectController::class, 'tools_store'])
